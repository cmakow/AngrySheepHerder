...
class Game {
  ...
  renderGameOver() {
    ...
    ctx.strokeText(`Score: ${this.score}`, scoreXpos, 250);
    ctx.fillText(`Score: ${this.score}`, scoreXpos, 250);
    ctx.strokeText('Click anywhere to start over', 135, 300);
    ctx.fillText('Click anywhere to start over', 135, 300);
